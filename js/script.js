...
var rounds = [1, 5, 3, 3, 2] // Punkte die man braucht um die jeweilige Runde zu beenden
...
var Game = {
    initialize() {
        ...
        this.player = new Player(this.canvas.width,this.canvas.height,'left')
        this.ai = new Player (this.canvas.width,this.canvas.height,'right')
    ...
    menu() {
        ...
        this.context.fillText('Beliebige Taste drücken um zu ',
            this.canvas.width / 2,
    ...
    draw() {
        ...
        this.context.drawImage(image,this.canvas.width/2-25,500,50,50)
    ...
    listen() {
        ...
        document.addEventListener('keyup', () => Pong.player.move = DIRECTION.IDLE)
    },
 
    // Reset the ball location, the player turns and set a delay before the next round begins.
    _resetTurn(victor, loser) {
        this.ball = new Ball(this.canvas.width,this.canvas.height,this.ball.speed)
        this.turn = loser
